...
workspace_limits = np.asarray([[0.36, 0.46], [0.38, 0.48], [0.10, 0.30]])

calib_grid_step = 0.05 #0.02
#checkerboard_offset_from_tool = [0,-0.13,0.02]  # 标定板中心距离工具末端的距离
checkerboard_offset_from_tool = [0,0.094,0]
# tool_orientation = [-np.pi/2,0,0] # [0,-2.22,2.22] # [2.22,2.22,0]
tool_orientation = [1.88,1.57,2.66]  # 工具末端的rpy角
#---------------------------------------------
...
def get_rigid_transform_error(z_scale):
    ...
    # print(np.asarray(measured_pts))
    # print(np.asarray(new_observed_pts))
